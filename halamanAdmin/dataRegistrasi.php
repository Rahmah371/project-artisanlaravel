            ...
            $user = mysqli_query($conn,"SELECT * FROM tbl_register ");
                ...
                while($rowUser = mysqli_fetch_array($user)){
                    ...
                    echo"<tr>
                        ...
                        <a onClick=\"return confirm('Anda Yakin ingin Menghapusnya ?')\"  href='index.php?hapusRegister=$rowUser[id_register]' class='btn btn-danger'><span class='iconify' data-icon='bx:bx-trash' data-inline='false'></span></a>
                        </td>
                    </tr>";
                $no++;
                }
